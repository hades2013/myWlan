...
int addParameterToCommand(uint8_t *key, uint8_t *data, uint16_t dataSize);
int addParameterToCommandWithRawdata(uint8_t *rawData, uint32_t len, int isHeader);
int addParameterToCommandWithLen(uint8_t *key, uint8_t *data, uint16_t dataSize, uint16_t dataLen);
