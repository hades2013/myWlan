...
void * ftm_ant_dispatch(ftm_ant_pkt_type *ant_ftm_pkt, uint16 pkt_len)
{
   ...
   if (isLatestTarget()) {
      ...
      switch (ant_ftm_pkt->data[2])
      {
        case FTM_ANT_MESG_BROADCAST_DATA_ID:
        case FTM_ANT_MESG_ACKNOWLEDGED_DATA_ID:
        case FTM_ANT_MESG_BURST_DATA_ID:
        case FTM_ANT_MESG_EXT_BROADCAST_DATA_ID:
        case FTM_ANT_MESG_EXT_ACKNOWLEDGED_DATA_ID:
        case FTM_ANT_MESG_EXT_BURST_DATA_ID:
        case FTM_ANT_MESG_ADV_BURST_DATA_ID:
           pdata[0] = 0x0e;
        break;
        default:
           pdata[0] = 0x0c;
