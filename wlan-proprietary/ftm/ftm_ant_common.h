...
/* For Rome, which shares UART transport for ANT and BT */
#define FTM_ANT_MESG_BROADCAST_DATA_ID           ((uint8)0x4E)
#define FTM_ANT_MESG_ACKNOWLEDGED_DATA_ID        ((uint8)0x4F)
#define FTM_ANT_MESG_BURST_DATA_ID               ((uint8)0x50)
#define FTM_ANT_MESG_EXT_BROADCAST_DATA_ID       ((uint8)0x5D)
#define FTM_ANT_MESG_EXT_ACKNOWLEDGED_DATA_ID    ((uint8)0x5E)
#define FTM_ANT_MESG_EXT_BURST_DATA_ID           ((uint8)0x5F)
#define FTM_ANT_MESG_ADV_BURST_DATA_ID           ((uint8)0x72)
